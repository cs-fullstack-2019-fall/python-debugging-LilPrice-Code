...
class Books:
    def _init_(self, name, rating, genre, author): #you need two underscores on both sides of init
        self.name = name
        self.rating = rating
        self.genre = genre
        self.author = author
...
for eachBook in bookArray:
    print(eachBook.name()) #you don't need parenthesis at the end of name only to define name